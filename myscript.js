...
class Vehicless {
    constructor(name, ps, buildyear, distance_traveled, img) {
        this.name = name;
        this.ps = ps;
...
class Car extends Vehicless {
    constructor(name, ps, buildyear, distance_traveled, img, reg_date) {
        super(name, ps, buildyear, distance_traveled, img);
        this.reg_date = reg_date;
    }
}
class Motorcycle extends Vehicless {
    constructor(name, ps, buildyear, distance_traveled, img, cycle_type) {
        super(name, ps, buildyear, distance_traveled, img);
        this.cycle_type = cycle_type;
    }
}
class Bus extends Vehicless {
    constructor(name, ps, buildyear, distance_traveled, seats, img) {
        super(name, ps, buildyear, distance_traveled, img);
        this.seats = seats;
    }
}
class LKW extends Vehicless {
    constructor(name, ps, buildyear, distance_traveled, img, weight) {
        super(name, ps, buildyear, distance_traveled, img);
        this.weight = weight;
    }
}
